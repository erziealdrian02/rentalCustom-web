...
<div id="sidebar" class="bg-gray-900 text-white h-screen fixed left-0 top-0 overflow-y-auto z-40 flex flex-col">
    ...
    <nav class="p-3 space-y-0.5 flex-1 overflow-y-auto">
        ...
        <div class="pt-2" data-section="shipping">
            <div class="nav-section-header {{ $shippingActive ? 'section-has-active' : '' }}"
                 id="header-shipping" onclick="toggleNavSection('shipping')">
                <p class="nav-section-label">Shipping</p>
                <span class="section-active-dot"></span>
                <svg class="nav-section-chevron open" id="chevron-shipping" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </div>
            <div class="nav-section-items" id="section-shipping">
                @php $shippingItems = [
                    ['shipping.list',  'Shipping List',   '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 104 0m-4 0a2 2 0 114 0m6 0a2 2 0 104 0m-4 0a2 2 0 114 0"/></svg>'],
                    ['shipping.form', 'Create Delivery', '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M12 4v16m8-8H4"/></svg>'],
                ]; @endphp
        ...
        <div class="pt-2" data-section="monitoring">
            <div class="nav-section-header {{ $monitorActive ? 'section-has-active' : '' }}"
                 id="header-monitoring" onclick="toggleNavSection('monitoring')">
                <p class="nav-section-label">Rental Monitoring</p>
                <span class="section-active-dot"></span>
                <svg class="nav-section-chevron open" id="chevron-monitoring" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </div>
        ...
        <div class="pt-2" data-section="returns">
            <div class="nav-section-header {{ $returnsActive ? 'section-has-active' : '' }}"
                 id="header-returns" onclick="toggleNavSection('returns')">
                <p class="nav-section-label">Returns</p>
                <span class="section-active-dot"></span>
                <svg class="nav-section-chevron open" id="chevron-returns" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </div>
            <div class="nav-section-items" id="section-returns">
                @php $returnsItems = [
                    ['returns.tools', 'Return Tools', '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>'],
                    ['returns.form',  'Return Form',  '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>'],
                ]; @endphp
        ...
        <div class="pt-2" data-section="special">
            <div class="nav-section-header {{ $specialActive ? 'section-has-active' : '' }}"
                 id="header-special" onclick="toggleNavSection('special')">
                <p class="nav-section-label">Special Status</p>
                <span class="section-active-dot"></span>
                <svg class="nav-section-chevron open" id="chevron-special" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </div>
            <div class="nav-section-items" id="section-special">
                @php $specialItems = [
                    ['lost.tools', 'Lost Tools', '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>'],
                    ['sold.tools', 'Sold Tools', '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 14l6-6m-5.5.5h.01m4.99 5h.01M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16l3.5-2 3.5 2 3.5-2 3.5 2zM10 8.5a.5.5 0 11-1 0 .5.5 0 011 0zm5 5a.5.5 0 11-1 0 .5.5 0 011 0z"/></svg>'],
                ]; @endphp
        ...
        <div class="pt-2" data-section="reports">
            <div class="nav-section-header {{ $reportsActive ? 'section-has-active' : '' }}"
                 id="header-reports" onclick="toggleNavSection('reports')">
                <p class="nav-section-label">Reports</p>
                <span class="section-active-dot"></span>
                <svg class="nav-section-chevron open" id="chevron-reports" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/>
                </svg>
            </div>
            <div class="nav-section-items" id="section-reports">
                @php $reportsItems = [
                    ['reports.rental',    'Rental Report',    '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>'],
                    ['reports.revenue',   'Revenue Report',   '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 12l3-3 3 3 4-4M8 21l4-4 4 4M3 4h18M4 4h16v12a1 1 0 01-1 1H5a1 1 0 01-1-1V4z"/></svg>'],
                    ['reports.inventory', 'Inventory Report', '<svg class="nav-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M4 6h16M4 10h16M4 14h16M4 18h16"/></svg>'],
                ]; @endphp
